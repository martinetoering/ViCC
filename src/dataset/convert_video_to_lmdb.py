...
def make_dataset_lmdb(dataset_path, filename):
    ...
    print("Generate from:", dataset_path)
...
if __name__ == '__main__':
    # dataset_path is the frame source path, filename lmdb is where to store lmdb file

    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset_path", type=str, default='/home/mtoering/data_dpc/HMDB51/frame')
    parser.add_argument("--filename_lmdb", type=str, default='/home/mtoering/data_dpc/HMDB51/hmdb51_frame.lmdb')
    args = parser.parse_args()

    make_dataset_lmdb(dataset_path=args.dataset_path, filename=args.filename_lmdb)