...
if __name__ == '__main__':
    ...
    if args.dataset == 'ucf101':
        main_UCF101(v_root=args.v_root, f_root=args.f_root)

    if args.dataset == 'hmdb51':
        main_HMDB51(v_root=args.v_root, f_root=args.f_root)

    if args.dataset == 'k-400':
        main_kinetics400(v_root=args.v_root, f_root=args.f_root)