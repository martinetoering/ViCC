...
if __name__ == '__main__':
    ...
    if args.dataset == 'ucf101':
        main_UCF101(v_root=args.v_root, frame_root=args.frame_root, flow_root=args.flow_root)

    if args.dataset == 'hmdb51':
        main_HMDB51(v_root=args.v_root, frame_root=args.frame_root, flow_root=args.flow_root)
